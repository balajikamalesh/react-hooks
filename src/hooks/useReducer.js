//useReducer takes a reducer function and an initial state and spits out a dispatch 
//method using which we can change state using an action type and the current state
